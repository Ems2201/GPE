...
let firstFit2 = document.getElementById('firstFit2');
let firstFit3 = document.getElementById('firstFit3');
...
firstFit2.addEventListener('click', () => {
    // Se não haver valores no formulário
    if (input.value == '') {
        alert('Insira os Valores');
    }
...
firstFit3.addEventListener('click', () => {
    // Se não haver valores no formulário
    if (input.value == '') {
        alert('Insira os Valores');
    }
